					...
					<div className="row">
						<div className="col-4">
							<div className="rowTrai">
								...
								<p>
									Con cái được đi học miễn phí trường công từ tiểu học đến hết trung học, 
									học phí đại học bằng 1/3 chi phí của du học sinh.
								</p>
							</div>
						</div>
						<div className="col-4">
							<div className="rowGiua">
								<p>Được mở chi nhánh, văn phòng đại diện, buôn bán thương mại tại bất kỳ tiểu bang nào trên nước Mỹ</p>
								<p>Được hưởng những phúc lợi xã hội như dân bản xứ</p>
							</div>
						</div>
						<div className="col-4">
							<div className="rowPhai">
								<p>Đương đơn và người phụ thuộc (vợ/chồng và tất cả con cái dưới 21 tuổi độc thân được cấp visa làm việc,
								 học tập tại Mỹ tối đa 07 năm).
								</p>
								<p>Đương đơn cùng gia đình có thể đạt thẻ xanh sau 01 năm sinh sống, làm việc và học tập tại Mỹ.</p>
							</div>
						</div>
					</div>
					<div className="row">
