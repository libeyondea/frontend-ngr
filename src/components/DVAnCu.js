...
export default class DVAnCu extends Component {
	constructor() {
		super();
		this.state = {
			isOpen: false
								...
								<div className="col-lg-7">
									<div className="video-two__content">
										<p className="color01">
											...
											/>
											Tân con Đường Vàng (NRG) luôn tự hào là đơn vị đầu tiên và duy nhất có văn phòng tại
											Mỹ và có dịch vụ an cư tại Mỹ dành cho tất cả khách hàng. Không chỉ đồng hành trên con
											đường lấy thẻ xanh cho cả gia đình, Tân con Đường Vàng (NRG) còn bên cạnh khách hàng
											khi ổn định cuộc sống tại đất nước cờ hoa này. Văn phòng Tân con Đường Vàng (NRG) tại
											Mỹ sẽ hỗ trợ, tư vấn một cách tận tâm nhất ngay khi gia đình bạn vừa đặt chân xuống
											nước Mỹ từ việc đưa đón tại sân bay cho đến việc chọn nhà ở, chọn trường cho con, ổn
											định công việc kinh doanh… Tương lai và hạnh phúc của gia đình bạn cũng chính là niềm
											vui và trách nhiệm cao cả của Tân con Đường Vàng (NRG).
										</p>
										<p className="color01">
											<i
												className="fa fa-check"
											...
											/>
											Để hỗ trợ khách hàng một cách hoàn hảo nhất, Tân con Đường Vàng (NRG) luôn xây dựng và
											phát triển một đội ngũ chuyên nghiệp, hợp tác cùng những đơn vị uy tín, với nhiều kinh
											nghiệm cũng như có nhiều năm sinh sống tại Mỹ, hiểu rõ văn hóa, con người, luật pháp
											Mỹ.
										</p>
									</div>
								</div>
								<div className="col-lg-5 d-flex justify-content-lg-end justify-content-sm-start image-br">
									<div className="my-auto video121">
										<ModalVideo
											channel="youtube"
					...
					<div className="noidung">
						...
						<div className="DoiNgu">
							...
							<div className="card-deck" style={{ width: '80%', marginLeft: '120px' }}>
								...
								<div className="card">
									<img src="/assets/images/DinhCuMy/gam.jpg" className="card-img-top card-img1" alt="..." />
									<div className="card-body">
								...
								<div className="card">
									<img src="/assets/images/DinhCuMy/avatar.jpg" className="card-img-top card-img1" alt="..." />
									<div className="card-body">
								...
								<div className="col-6">
									<div className="nd-SOCVH1">
										<p>
											...
											“Cao su thời gian” là điều rất hay gặp ở học sinh Việt Nam nói riêng và châu Á nói
											chung. Trừ trường hợp bất khả kháng như ốm nặng phải đi cấp cứu hay tang thương mới có
											thể được chấp nhận là lý do để trễ hẹn. Sắp xếp thời gian sinh hoạt và học tập hợp lý,
											bắt đầu công việc và bài tập ngay lúc được giao và cố gắng hoàn thành công việc sớm
											nhất có thể chính là những biện pháp để bạn có thể làm chủ được thời gian và hoàn
											thành công việc đúng thời gian. CHỦ ĐỘ
										</p>
										<p>
											<i
												className="fa fa-check"
											...
											Mỹ là quốc gia đa sắc tộc cùng với nền lịch sử và văn hóa rất hấp dẫn. Chính vì lẽ đó
											khá nhiều bạn du học sinh cảm thấy bị lạc lõng trên nước Mỹ rộng lớn. Làm thế nào để
											vượt qua điều này? Rất đơn giản, chấp nhận và học hỏi những điều mới lạ. Các bạn cũng
											nên đơn giản hóa những điều mà mình không thể hiểu được (ví dụ như chuyện cười), chịu
											khó quan sát, lắng nghe cũng như cảm nhận những nền văn hóa khác nhau trên đất Mỹ. Bổ
											sung những kiến thức về văn hóa Mỹ qua trường lớp, phim ảnh và bạn bè hay tham gia
											những câu lạc bộ trong và ngoài trường là những điều nên làm để làm quen và thích nghi
											với văn hóa Mỹ.
										</p>
										<p>
											<i
											...
											<br />
											Mỹ rất tôn trọng sự tự do, chính vì thế duy trì khoảng cách giữa bạn và người khác là
											điều cần phải chú ý. Khi nói chuyện với ai đó, không nên đứng quá gần họ. Khoảng cách
											tiếp xúc quá gần làm cho người đối diện cảm thấy không thoải mái và họ có thể cho rằng
											bạn đang xâm phạm không gian cá nhân của họ. Không chỉ trong giao tiếp mà ngay cả
											những tình huống hàng ngày như xếp hàng nơi công cộng hay đi bộ trên vỉa hè, duy trì
											khoảng cách cũng là điều vô cùng quan trọng.
										</p>
										<p>
											<i
												className="fa fa-check"
											...
											Đây là cơ hội tốt nhất cho du học sinh tìm hiểu về các truyền thống của trường, làm
											quen với bạn bè quốc tế cũng như người bản xứ. Bạn sẽ tìm hiểu được mọi thông tin về
											các câu lạc bộ, hội nhóm phù hợp với bạn. Không gì có thể dễ dàng và đơn giản hơn việc
											làm quen với những người bạn mới khi tham gia các câu lạc bộ ngoại khoá của trường,
											tại đây, họ đa phần sẽ là những người có cùng sở thích và mối quan tâm giống với bạn.
										</p>
									</div>
								</div>
								<div className="col-6">
									{/* 	<div className="video">
										<div className="my-auto">
											<ModalVideo
												...
												onClose={() => setisopen(false)}
											/>
											<div onClick={this.openModal} className="media-play-icon-DVAC">
												<i className="fas fa-play media-icon" />
											</div>
										</div>
									</div> */}
