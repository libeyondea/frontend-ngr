						...
						<div className="course-details__content">
							...
							<div className="tab-content course-details__tab-content ">
								<div className="tab-pane show active  animated fadeInUp content_1" role="tabpanel" id="overview">
									<p className="titlee">
										<strong>Vị trí tuyển dụng: </strong>Copywriter
									</p>
									<p>
									...
									<ul>
										<li className="list">
											Tìm kiếm nguồn thông tin từ sách, báo, tạp chí, internet&#8230; và tổng hợp theo chủ
											đề
										</li>
									...
									<ul>
										<li className="list">
											Tốt nghiệp Cao đẳng/Đại học chuyên ngành báo chí, ngoại ngữ, biên phiên dịch, văn
											học&#8230;
										</li>
										...
										<li className="list">
											Thân thiện, vui vẻ, khả năng hòa đồng tốt với môi trường làm việc
										</li>
										<li className="list">Có tư duy quản lý, sắp xếp thời gian phù hợp</li>
										<li className="list">
											Ưu tiên hiểu biết về Social, SEO, có kinh nghiệm và từng quản lý các dự án lớn
										</li>
									</ul>
									<p>
									...
									<ul>
										<li className="list">
											Ký hợp đồng lao động chính thức, lương + thưởng theo hiệu quả, đóng góp và thái độ
											trong công việc
										</li>
										<li className="list">Tăng lương định kỳ theo quy chế công ty</li>
										<li className="list">
											Chế độ làm việc, BHXH, BHYT, nghỉ phép, nghỉ lễ… theo quy định của Bộ Luật Lao động
										</li>
										<li className="list">
											Cơ hội đi công tác, du lịch trong và ngoài nước, các hoạt động team building
										</li>
									...
									<p>
										<strong>Lương và đãi ngộ</strong>:
									</p>
									<ul>
										<li className="list">Mức lương thỏa thuận theo năng lực và kinh nghiệm</li>
										<li className="list">
											Được hưởng các chế độ phúc lợi đầy đủ theo pháp luật nhà nước, Luật Lao động
										</li>
										<li className="list">
											Được thưởng lễ, tết theo chế độ nhà nước và chính sách đãi ngộ riêng của công ty
										</li>
									</ul>
									<p>
										<strong>Hình thức làm việc:</strong> Toàn thời gian
									</p>
									<p>
										<strong>Nơi làm việc:</strong> Thành phố Hồ Chí Minh
									</p>
									<p>
										<strong>Cách thức ứng tuyển: </strong>Hồ sơ ghi rõ vị trí dự tuyển gửi trực tuyến qua địa
										chỉ email:{' '}
										<a href="mailto:hr@inec.vn" target="_blank" rel="noopener noreferrer">
											hr@inec.vn
										</a>
										. Hồ sơ xin việc có kèm một số bài đã viết trước đây hoặc những dự án từng tham gia. Ứng
										viên phù hợp sẽ được mời kiểm tra và phỏng vấn trực tiếp tại Văn phòng INEC, 279 Trần Nhân
										Tôn, Phường 2, Quận 10, TP. HCM.
									</p>
									<p>
										<strong>Thời hạn nhận hồ sơ</strong>: Từ ngày 20/11/2021 đến hết ngày 15/12/2021
									</p>
								</div>
								<div className="tab-pane  animated fadeInUp" role="tabpanel" id="curriculum">
									<span className="lienhe">
										<strong>Mọi chi tiết xin v</strong>
										<strong>ui lòng liên hệ:</strong>
									</span>

									<br />
									<p className="auto">
										<strong>
											<span>DU HỌC</span>&nbsp;<span>TÂN CON ĐƯỜNG VÀNG – NEW GOLDEN ROAD</span>
										</strong>
									</p>

									<p dir="auto" style={{ textAlign: 'center' }}>
										Website:&nbsp;<a href="https://newgoldenroad.com/">https://newgoldenroad.com/</a>
									</p>
									<p dir="auto" style={{ textAlign: 'center' }}>
									...
									<p dir="auto" style={{ textAlign: 'center' }}>
										Email: tanconduongvang@gmail.com
									</p>

									<p dir="auto" style={{ textAlign: 'center' }}>
										Facebook:&nbsp;
										<a href="https://www.facebook.com/newgoldenroad">
											https://www.facebook.com/newgoldenroad
										</a>
									</p>
									...
									<ul className="course-details__curriculum-list list-unstyled">
										...
										<li>
											<div className="course-details__curriculum-list-left">
												...
												<a href="#"> tanconduongvang@gmail.com</a> <span>Preview</span>
											</div>
