      ...
      <div className="row">
        <div className="col-sm-6 col-xl-3 align-self-center">
          <div className="single_feature_text ">
            ...
            <p>Set have great you male grass yielding an yielding first their
      ...
      <div className="row align-items-sm-center align-items-lg-stretch">
        ...
        <div className="col-md-5 col-lg-5">
          <div className="learning_member_text">
            ...
            <ul>
              <li><span className="ti-pencil-alt" />Him lights given i heaven second yielding seas
                gathered wear</li>
              <li><span className="ti-ruler-pencil" />Fly female them whales fly them day deep given
                night.</li>
            </ul>
            <a href="#" className="btn_1">Read More</a>
          </div>
      ...
      <div className="row">
        ...
        <div className="col-sm-6 col-lg-4">
          <div className="single_special_cource">
            ...
            <div className="special_cource_text">
              <a href="course-details.html" className="btn_4">design</a>
              <h4>$160.00</h4>
        ...
        <div className="col-sm-6 col-lg-4">
          <div className="single_special_cource">
            ...
            <div className="special_cource_text">
              <a href="course-details.html" className="btn_4">Wordpress</a>
              <h4>$140.00</h4>
