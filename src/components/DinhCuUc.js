			...
			<div className="row">
				<div className="col-lg-8">
					<div className="noidung">
						<h1 className="tieudeTH">CHƯƠNG TRÌNH ĐỊNH CƯ DIỆN DOANH NHÂN TÀI NĂNG - VISA SUBCLASS 132A – Du học Tân Con Đường Vàng</h1>
						<h2 className="mucTH">1. TỔNG QUAN VỀ CHƯƠNG TRÌNH </h2>	
						<div style={{ color: '#333', fontSize: '20px', fontWeight: 'lighter' }}>	
						Visa 132 là chương trình định cư Úc diện doanh nhân tài năng (Business Talent) là một thị thực thường trú cho những người kinh doanh, 
						người được đề của bởi một cơ quan chính phủ tiểu bang hoặc vùng lãnh thổ Úc. Với số tiền đầu tư 1.500.000 AUD Visa 132 cho phép đương đơn và gia đình tiến thẳng đến quyền thường trú nhân vĩnh viễn. 
						</div>
						<h2 className="mucTH">2.  QUYỀN LỢI CỦA VISA 132A</h2>
						<div style={{ color: '#333', fontSize: '20px', fontWeight: 'lighter' }}>
								<ul>
								<li> &#10004; Đương đơn và gia đình gồm vợ chồng và con cái dưới 23 tuổi còn độc thân, chứng minh được phụ thuộc tài chính sẽ được cấp visa thường trú.</li>
								<li> &#10004; Được nhập tịch sau 4 năm/5 năm toàn thời gian tại Úc.</li>
								<li> &#10004; Được học miễn phí từ lớp 1 đến 12 (công lập) và làm việc tại Úc.</li>
								<li> &#10004; Được sống trong môi trường sống an toàn và có chất lượng cuộc sống cao nhất thế giới.</li>
								<li> &#10004; Con được sinh ra trong nước Úc sẽ trở thành công dân Úc.</li>
						...
						<div>
							...
							<div style={{ color: '#333', fontSize: '20px', fontWeight: 'lighter' }}>
								<ul>
									<li>
										&#10004; Tự do đi lại, sinh sống và làm việc bất cứ nơi nào tại Úc
									</li>
									<li>
										&#10004; Miễn visa đi đến 168 quốc gia trên thế giới
									</li>
									<li>
										&#10004; Miễn học phí từ tiểu học đến trung học phổ thông (trường công lập)</li>
									<li>
										&#10004; Hưởng mọi đặc quyền về y tế và an sinh xã hội của Úc
									</li>
									<li>
										&#10004; Được tự bầu cử tự ứng cử
									</li>
									<li>
										&#10004; Được giữ song tịch
									</li>
									...
									<li>
										&#10004; Được trợ cấp sở hữu nhà đầu tiên tại Úc 
									</li>
								</ul>
							</div>
						</div>
						<div>
							<h2 className="mucTH">4. ĐIỀU KIỆN THAM GIA </h2>
							<div style={{ color: '#333', fontSize: '20px', fontWeight: 'lighter' }}>
								<ol>
									<li> ● Được đề cử bởi tiểu bang/vùng lãnh thổ tại Úc</li>
									<li> ● Nhận được thư mời nộp visa</li>
									<li> ● Người đứng đơn dưới 55 tuổi</li>
									<li> ● Không có liên quan đến các hoạt động kinh doanh bất hợp pháp.</li>
									<li> ● Đương đơn và tất cả thành viên gia đình phải đạt những điều kiện về sức khỏe và lý lịch tư pháp.</li>
									<li> ● Mong muốn rõ ràng về việc sở hữu và duy trì vai trò quản lý kinh doanh ở Úc</li>
									<li> ● Có lịch sử kinh doanh thành công</li>
									<li> ● Đương đơn hoặc vợ chồng phải thỏa mãn được tất cả các điều kiện sau:</li>
										<ul>
										<li> &#10036; Vốn chủ sở hữu trong các công ty đạt tối thiểu 400.000 AUD trong 2 trên 4 năm tài chính gần nhất, 
											ngay trước khi nhận được thư mời nộp visa và nếu doanh nghiệp đã công khai niêm yết thì cổ phần đạt tối thiểu 10%.</li>
										<li> &#10036; Tổng tài sản doanh nghiệp và tài sản cá nhân hợp pháp đạt 1.5 triệu AUD và có thể chuyển sang Úc trong 2 năm sau khi được cấp visa.</li>
										</ul>
									<li> ● Tổng doanh thu hàng năm của các doanh nghiệp, đạt tối thiểu 3 triệu AUD trong tối thiểu 2 trên 4 năm gần nhất, ngay trước khi nhận được thư mời nộp visa</li>
									<li> ● Sở hữu tối thiểu:</li>
									<ul>
										<li> &#10036; 51% nếu doanh thu dưới 400.000 AUD/ năm.</li>
										<li> &#10036; 30% nếu doanh thu trên 400.000 AUD/ năm.</li>
										</ul>
								</ol>
						...
						<div>
							<h2 className="mucTH">5. NGHĨA VỤ CỦA ĐƯƠNG ĐƠN </h2>
							<div style={{ color: '#333', fontSize: '20px', fontWeight: 'lighter' }}>
							<ol>
									<li> ● Nếu đương đơn không ở Úc tại thời điểm visa được cấp, đương đơn phải nhập cảnh vào Úc tại ngày đã được chỉ định bởi Bộ di trú Úc.</li>
									<li> ● Các thành viên trong gia đình của đương đơn không được phép kết hôn hay có mối quan hệ thực tế (de facto relationship) trước khi họ nhập cảnh vào Úc (sẽ được hướng dẫn rõ bởi Bộ di trú Úc nếu điều kiện này được áp dụng).</li>
									<li> ● Đương đơn và gia đình phải tuân thủ tất cả các điều kiện của visa cũng như tuân thủ luật pháp tại Úc.</li>
									<li> ● Đương đơn phải tuân thủ các điều kiện về doanh nghiệp.</li>
									<li> ● Phải thông báo địa chỉ thường trú với Bộ di trú Úc trong vòng 6 tháng kể từ ngày nhập cảnh vào Úc.</li>
									<li> ● Đương đơn phải thông báo nếu thay đổi nơi sinh sống (kể cả trong hay ngoài nước Úc) bằng đơn 929 trong vòng 28 ngày trước khi di chuyển đến nơi ở mới.</li>
									<li> ● Sau khi nhập cảnh Úc, đương đơn cần: </li>
									<ul>
										<li> &#10036; Thành lập một doanh nghiệp đủ điều kiện tại Úc hoặc</li>
										<li> &#10036; Tham gia vào một doanh nghiệp có sẵn tại Úc. </li>
										</ul>
									<li> ● Trong doanh nghiệp đó, đương đơn cần:</li>
									<ul>
										<li> &#10036; Duy trì vốn sở hữu đáng kể</li>
					...
					<ul className="flat-social">
						<li>
							<a
								...
								target="_blank"
							>
								<svg style={{marginBottom: '5px',marginRight: '5px'}}
