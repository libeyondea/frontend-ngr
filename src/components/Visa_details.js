		...
		<div className="THdetails">
			<section className="inner-banner-THCA">
				<div className="container">
					<h2 className="inner-banner-THCA__title">VISA CANADA</h2>
				</div>
			</section>
			...
			<div className="row">
				<div className="col-lg-8">
					<div className="noidung">
						<h1 className="tieudeTH">[Du học Canada] – Lễ tốt nghiệp cấp ba của bạn Anna Phan – Du học Canada – Du học Tân Con Đường Vàng</h1>

						<div style={{ color: '#333', fontSize: '20px', fontWeight: 'lighter' }}>
							<strong>
								<b>Vừa rồi, một bạn du học sinh vô cùng xinh xắn của tập thể Du học Tân Con Đường Vàng – Anna Phan </b>
							</strong>
		 ...
		 thành công hơn nữa trên con đường học tập của mình. Hãy cố gắng nhiều hơn em nhé, vì tương lai tươi sáng vẫn đang chờ em ở phía trước.<br/>
							</div>
						...
						<div>
							...
							<div style={{ color: '#333', fontSize: '20px', fontWeight: 'lighter', paddingBottom:'10px' }}>
							Sự thành công của các bạn du học sinh luôn là động lực và là niềm vinh hạnh của chúng tôi. Bằng tất cả
							 sự nổ lực của mình, chúng tôi sẽ luôn sát cánh, hỗ trợ cho các bạn. Nhiệm vụ chắp cánh ước du học luôn là
							  sứ mệnh của chúng tôi. Chúng tôi sẽ giải đáp tất tần tật các câu hỏi cũng như thắc mắc của các bạn. Dịch vụ 
							  hỗ trợ tận tình cùng với mức chi phí rất phải chăng, ngoài ra, các bạn còn có cơ hội nhận thêm nhiều học bổng
							   nữa đấy. Quá hời đúng không nào ….. đợi chờ gì nữa, liên hệ ngay với chúng tôi nhé.
							</div>
