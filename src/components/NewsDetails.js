...
const NewsDetails = ({ post }) => {
	...
	return (
		<div className="THdetails">
			...
			<div>
				<p className="post-meta  tile1 crumbss-school">
				...
				<div className="col-lg-8">
					<div className="noidung">
						...
						{/* <div style={{ color: '#333', fontSize: '20px', fontWeight: 'lighter' }}>
							...
							là một trường trung học nội trú tư thục được thành lập vào năm 1991, trường tọa lạc tại thành phố đẹp
						...
						<div style={{ color: '#333', fontSize: '20px', fontWeight: 'lighter' }}>
							{' '}
							Cử nhân thương mại Chương trình học của trường Bodwell High School được kiểm tra cẩn thận, có ý nghĩa,
							đa dạng, cân bằng và quan trọng nhất là tăng cường sự phát triển hài hòa về nhân cách, trí tuệ và thể
							chất. Trường Bodwell không ngừng đảm bảo sự cải thiện và điều chỉnh chương trình học theo các tiêu
							chuẩn của Sở Giáo Dục British Columbia.
							<ul>
						...
						<div>
							...
							<div style={{ color: '#333', fontSize: '20px', fontWeight: 'lighter' }}>
								<ul>
									<li>
										{' '}
										&#10004; Cơ sở vật chất hiện đại với một hồ bơi trong nhà, 2 phòng tập, 2 giảng đường, 2
										căn tin, các phòng thí nghiệm khoa học, một thư viện và một phòng nhạc.
									</li>
									<li>
										{' '}
										&#10004; Tỷ lệ học sinh đậu tốt nghiệp hằng năm là 97% và được ghi danh vào các trường Đại
										học danh tiếng ở Canada.
									</li>
									<li>
										{' '}
										&#10004; Có đội ngũ tư vấn giúp đỡ cho du học sinh khi gặp vấn đề khó khăn và hướng dẫn
										chọn trường đại học phù hợp với sở thích của từng du học sinh.
									</li>
									<li>
										{' '}
										&#10004; Bodwell cấp cho tất cả học sinh laptop được tối ưu cho nghiên cứu học tập, gồm có
										phần mềm thiết yếu như Microsoft Office 365, Adobe Creative Cloud.
									</li>
								</ul>
							</div>
							<p style={{ textAlign: 'center' }}>
						...
						<div>
							...
							<div style={{ color: '#333', fontSize: '20px', fontWeight: 'lighter' }}>
								Ngoài việc học tập, Bodwell cũng chú trọng vào tinh thần và thể chất của học sinh. Trường thường
								tổ chức nhiều sự kiện văn hóa, giải trí:
								<ul>
									<li> &#10004; Các chuyến tham quan rạp hát</li>
									<li> &#10004; Các cuộc thi đấu thể thao</li>
									<li>
										{' '}
										&#10004; Các chuyến dã ngoại đến những thành phố khác nhau ở Canada và tất cả học sinh đều
										phải tham gia.
									</li>
								</ul>
							</div>
						...
						<div>
							...
							<div style={{ color: '#333', fontSize: '20px', fontWeight: 'lighter' }}>
								Học sinh sống trong các ký túc xá tại trường sẽ được ở tại các căn phòng (3-4 học sinh) có thể
								nhìn ra phong cảnh tuyệt đẹp với núi non và vịnh biển. Các nam nữ học sinh sống trong các khu
								riêng trong ký túc xá dưới sự giám sát 24/24 của các tư vấn viên thanh niên. Ngoài cung cấp dịch
