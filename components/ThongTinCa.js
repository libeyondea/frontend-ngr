						...
						<div className="blog-one__single">
							...
							<div className="blog-one__content text-center">
								...
								<h2 className="blog-one__title">
									<Link href="/news-details">
										<a>Summer high school journalism camp</a>
									</Link>
								</h2>
					...
					<div className="col-lg-4">
						<div className="blog-one__single">
							...
							<div className="blog-one__content text-center">
								...
								<h2 className="blog-one__title">
									<Link href="/news-details">
										<a>Get a tips to develop a quality education</a>
									</Link>
								</h2>
								<p className="blog-one__text">
									Aelltes port lacus quis enim var sed efficitur turpis gilla sed sit amet finibus eros.
					...
					<div className="col-lg-4">
						<div className="blog-one__single">
							...
							<div className="blog-one__content text-center">
								...
								<h2 className="blog-one__title">
									<Link href="/news-details">
										<a>Learn variety of programs and courses</a>
									</Link>
								</h2>
								<p className="blog-one__text">
									Aelltes port lacus quis enim var sed efficitur turpis gilla sed sit amet finibus eros.
					...
					<div className="col-lg-4">
						<div className="blog-one__single">
							...
							<div className="blog-one__content text-center">
								...
								<h2 className="blog-one__title">
									<Link href="/news-details">
										<a>English lectures in french language courses</a>
									</Link>
								</h2>
								<p className="blog-one__text">
									Aelltes port lacus quis enim var sed efficitur turpis gilla sed sit amet finibus eros.
					...
					<div className="col-lg-4">
						<div className="blog-one__single">
							...
							<div className="blog-one__content text-center">
								...
								<h2 className="blog-one__title">
									<Link href="/news-details">
										<a>Subject that fits your busy life styles</a>
									</Link>
								</h2>
								<p className="blog-one__text">
									Aelltes port lacus quis enim var sed efficitur turpis gilla sed sit amet finibus eros.
					...
					<div className="col-lg-4">
						<div className="blog-one__single">
							...
							<div className="blog-one__content text-center">
								...
								<h2 className="blog-one__title">
									<Link href="/news-details">
										<a>Are you ready to become a best student</a>
									</Link>
								</h2>
								<p className="blog-one__text">
									Aelltes port lacus quis enim var sed efficitur turpis gilla sed sit amet finibus eros.
