		...
		<div className="THdetails">
			...
			<div className="row">
				...
				<h1 className="tieudeTH">BODWELL HIGH SCHOOL – Vancouver, British Columbia– Du học Tân Con Đường Vàng</h1>
					...
					Chương trình học của trường Bodwell High School được kiểm tra cẩn thận, có ý nghĩa, đa dạng,
					 cân bằng và quan trọng nhất là tăng cường sự phát triển hài hòa về nhân cách, trí tuệ và thể chất. Trường Bodwell
					  ...
					  <ul >
							<li > &#10004; Bậc đào tạo: lớp 8-12</li>
							<li > &#10004; Chương trình dự bị đại học</li>
							<li > &#10004; Tiếng anh học thuật và dự bị</li>
							<li > &#10004; Khóa học hè</li>
							</ul>
					</div>
					<div className="anh-noidung1">
				...
				<div>
					...
					<div style={{ color: '#333', fontSize: '20px', fontWeight: 'lighter' }}>
					<ul >
							<li > &#10004; Cơ sở vật chất hiện đại với một hồ bơi trong nhà, 2 phòng tập, 2 giảng đường, 2 căn tin, các phòng thí nghiệm khoa học, một thư viện và một phòng nhạc.</li>
							<li > &#10004; Tỷ lệ học sinh đậu tốt nghiệp hằng năm là 97% và được ghi danh vào các trường Đại học danh tiếng ở Canada.</li>
							<li > &#10004; Có đội ngũ tư vấn giúp đỡ cho du học sinh khi gặp vấn đề khó khăn và hướng dẫn chọn trường đại học phù hợp với sở thích của từng du học sinh.</li>
							<li > &#10004; Bodwell cấp cho tất cả học sinh laptop được tối ưu cho nghiên cứu học tập, gồm có phần mềm thiết yếu như Microsoft Office 365, Adobe Creative Cloud.</li>
							</ul>
							</div>
							<div className="anh-noidung1">
						<img
				...
				<div>
					...
					<ul >
							<li > &#10004; Các chuyến tham quan rạp hát</li>
							<li > &#10004; Các cuộc thi đấu thể thao</li>
							<li > &#10004; Các chuyến dã ngoại đến những thành phố khác nhau ở Canada và tất cả học sinh đều phải tham gia.</li>
							</ul>
							</div>
							<div className="anh-noidung1">
						<img
