...
const CacTruongCanada1 = () => {
	return (
		<div>
			<section class="inner-banner-THCA">
				<div class="container">
					...
					<h2 class="inner-banner-THCA__title">Các Trường Đại Học <br/>Và Cao Đẳng Canada</h2>
				</div>    
			</section>    
			...
			<div class="col-lg-7">
				<div class="card-TH">
					<div class="card-header">
						<p class="card-header-TH">Trường Southern Alberta Institute of Technology (SAIT) – Du học Canada – Du học Tân Con Đường Vàng</p>
					</div>
					<div class="card-body">
						<p class='img-card-TH'>
						...
						<p class="card-text-TH">SASKATCHEWAN POLYTECHNIC  Saskatchewan Polytechnic được thành lập vào năm 1941 tọa lạc tại Saskatchewan –
				...
				<div class="card-TH">
					<div class="card-header">
						<p class="card-header-TH">Trường British Columbia University – Du học Canada – Du học Tân Con Đường Vàng</p>
					</div>
					<div class="card-body">
						<p class='img-card-TH'>
						...
						<p class="card-text-TH">BRITISH COLUMBIA UNIVERSITY British Columbia – ngôi trường của những giải Nobel và những người nổi tiếng. 
				...
				<div class="card-TH">
					<div class="card-header">
						<p class="card-header-TH">Trường Coast Mountain College – Du học Canada – Du học Tân Con Đường Vàng</p>
					</div>
					<div class="card-body">
						<p class='img-card-TH'>
						...
						<p class="card-text-TH">COAST MOUNTAIN COLLEGE Coast Mountain College (CMTN) được thành lập dưới sự công nhận của Chính phủ. 
