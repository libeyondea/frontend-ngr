			...
			<div className="col-lg-7">
				<div className="card-TH">
					...
					<div className="card-body">
						...
						<p className="card-text-TH">
							SASKATCHEWAN POLYTECHNIC Saskatchewan Polytechnic được thành lập vào năm 1941 tọa lạc tại Saskatchewan
							– nơi được ví von là “Land of Living Skies” của Canada. Cùng với 12 cơ sở nghiên cứu chuyên sâu,
							Saskatchewan Polytechnic còn là thành viên của Nhóm các trường bách khoa Canada (Polytechnics Canada)
							…
						</p>
				...
				<div className="card-TH">
					...
					<div className="card-body">
						<p className="img-card-TH">
							<Image
								src="/assets/images/TruongHoc/SASK.png"
								alt="Trường Saskatchewan Polytechnic"
								width="165"
								height="100"
							/>
						</p>
				...
				<div className="card-TH">
					...
					<div className="card-body">
						<p className="img-card-TH">
							<Image
								src="/assets/images/TruongHoc/BRITI.png"
								alt="Trường British Columbia University"
								width="165"
								height="100"
							/>
						</p>
						...
						<p className="card-text-TH">
							...
							tiếng. Nếu Mỹ có Đại học Havard, Anh có Đại học Oxford thì Canada có Đại học British Columbia. Du học,
							ai cũng mong được sở hữu tấm bằng của những trường danh tiếng. …
						</p>
						<a href="#" className="btn btn-primary">
							Đọc Thêm
						</a>
				...
				<div className="card-TH">
					...
					<div className="card-body">
						<p className="img-card-TH">
							<Image
								src="/assets/images/TruongHoc/COAST.png"
								alt="Trường Coast Mountain College"
								width="165"
								height="100"
							/>
						</p>
						...
						<p className="card-text-TH">
							COAST MOUNTAIN COLLEGE Coast Mountain College (CMTN) được thành lập dưới sự công nhận của Chính phủ.
							Toạ lạc tại khu vực cộng đồng dân cư thịnh vượng và đa dạng của Tây Bắc thuộc tỉnh British Columbia.
							Coast Mountain College cung cấp nhiều chương trình đào tạo chất lượng với …
						</p>
						<a href="#" className="btn btn-primary">
							Đọc Thêm
						</a>
